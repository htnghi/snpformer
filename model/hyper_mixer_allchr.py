...
class MixerModel(nn.Module):
    ...
    def forward(self, x):
        ...
        x = self.embedding(x)
        # print('shape after embedding', x.shape) #(batch_size, maxlen, embedding_dim)

        # print('in Mixermodel')
        for mixer_layer in self.mixers:
            x = mixer_layer(x, mask)
...
# ==============================================================
def tuning_regular_hypermixer_test1(datapath, X_train, src_vocab_size, y, data_variants, training_params_dict, device):
...
# ==============================================================
def evaluate_result_regular_hypermixer_test1(datapath, X_train, src_vocab_size, y_train, X_test, y_test, best_params, data_variants, device):
